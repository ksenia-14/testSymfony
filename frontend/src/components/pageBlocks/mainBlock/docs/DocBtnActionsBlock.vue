<script setup>
import ButtonDelete from '@/components/pageBlocks/mainBlock/docs/docBtnActions/ButtonDelete.vue';
import ButtonDownload from '@/components/pageBlocks/mainBlock/docs/docBtnActions/ButtonDownload.vue';
